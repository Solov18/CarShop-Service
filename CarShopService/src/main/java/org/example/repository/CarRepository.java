...
public class CarRepository {
    ...
    public void addCar(Car car) {
        jdbcTemplate.update(INSERT_CAR_SQL, car.getMake(), car.getModel(), car.getYear(), car.getPrice(), car.getCondition(), car.isAvailable());
    }
    ...
    public Optional<Car> getCarById(int id) {
        try {
            ...
            // Логирование ошибки (замените System.err на ваш логер)
    ...
    public boolean updateCar(Car car) {
        return jdbcTemplate.update(UPDATE_CAR_SQL, car.getMake(), car.getModel(), car.getYear(), car.getPrice(), car.getCondition(), car.isAvailable(), car.getId()) > 0;
    }
